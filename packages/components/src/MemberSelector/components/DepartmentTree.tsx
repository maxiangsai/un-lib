...
const DepartmentTree = (props: Props) => {
  ...
  return (
    <Pane title="部门">
      <div className="unicom-member-selector-depart-tree">
        <Input.Search
          placeholder="请输入部门名称，按回车搜索"
          onSearch={searchHandle}
        />

        <div className="unicom-member-selector-depart-tree__content">
          {loading ? (
            <Spin
              className="unicom-member-selector-depart-tree__loading"
              tip="正在加载部门数据"
            />
          ) : isSearch ? (
